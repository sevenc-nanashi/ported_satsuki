...
obj.oz = obj.rand(-obj.screen_w, obj.screen_w, obj.index, track3) * zscale
    + obj.rand(1, track3, obj.index, track3) * zsign * obj.time
obj.rx = obj.rand(0, 359, obj.index, track1) + obj.rand(8, 64, obj.index, track1) * xsign * obj.time
obj.ry = obj.rand(0, 359, obj.index, track2) + obj.rand(8, 64, obj.index, track2) * ysign * obj.time
obj.rz = obj.rand(0, 359, obj.index, track3) + obj.rand(8, 64, obj.index, track3) * zsign * obj.time
