...
---$check:透明度あり
local has_transparency = true

---$check:縦横比あり
local has_aspect_ratio = true
...
obj.aspect = interpolate_track("track.aspect_ratio", has_aspect_ratio) / 100
obj.draw(
    0,
    0,
    0,
    interpolate_track("track.scale", has_scale) / 100,
    1 - interpolate_track("track.transparency", has_transparency) / 100
)
